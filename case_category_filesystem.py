#!/usr/bin/python3 -u
# This script is used for categorising cases for Filesystem
...
category_meta_data = { #"Upgrade": [ "upgrade", "install" ],
    "nfs": {"not responding": [], "lock reclaim": [], "nobody": [], "stateid": [], "id mapping": [],
            "bad-seqid": [], "nfsd": [], "mountd": [], "lockd": [], "pnfs": [], "statd": [], "nfs-utils": [],
            "df hung": [], "df stuck": [], "ls lung": [], "ls stuck": [], "nfs slowness": [], "nfs delay": [],
            "nfs performance": [], "nfs permission": [], "nfs service not starting": [], "nfs": []
            },
    "cant_boot": {"emergency": [], "maintenance": [], "system doesn't start": [], "not able to boot": [],
                  "Ctrl-D": [], "cannot boot": [], "unable to boot": [], "fails to boot": [], "dracut": [],
                  "grub": []
                  },
    "cifs": {"has not responded": [], "host is down": [], "dfs": [], "fips": [], "samba mount error": [],
             "status_logon_failure": [], "error 13": [], "required key not available": [], "cifs-utils": [],
             "unable to mount cifs": [], "fails to mount cifs": [], "cifs": []
             },
    "autofs": {"automount": [], "autofs timeout": [], "stays mounted": [], "not unmounting": [],
               "autofs not starting": [], "/net": [], "x-systemd.automount": [],  "autofs hung": [],
               "autofs": [],
               },
    "xfs": {"not mounting": [], "failed to mount": [], "corrupt": [], "quota": [], "xfs_repair": [],
            "I/O error": [], "fatal error": [], "filesystem issue": [], "xfs_growfs": [], "xfs": [],
            },
    "ext4": {"not mounting": [], "corrupt": [], "e2fsck": [], "clean with errors": [], "I/O error": [],
             "extend": [], "resize2fs": [], "fs error": [], "reduce": [], "ext4": [],
             },
    "Others": {"other": []
               }
}
